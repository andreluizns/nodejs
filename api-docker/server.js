...
var client_ts_1 = require("./src/database/client.ts");
var schema_ts_1 = require("./src/database/schema.ts");
...
server.get("/courses", function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, client_ts_1.db.select().from(schema_ts_1.courses)];
            case 1:
                result = _a.sent();
                // sempre retorne um objeto
                return [2 /*return*/, response.send({ result: result })];
        }
    });
}); });
/*
...
*/
server.listen({ port: 3333 }).then(function () {
